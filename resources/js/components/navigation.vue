...
<div class="cat-nav">
	<div class="navbar" id="navigation">
		<ul id="nav-ul">
			...
			<li class="nav-list" v-for="(category,index) in my_array" :key="index" @mouseover="darkenBody()" @mouseleave="lightenBody()">
...
export default {
	...
	methods: {
		...
		lightenBody(){
			...
			document.getElementsByClassName('auth-m')[0].className = 'auth';
        },
	},
};
</script>
